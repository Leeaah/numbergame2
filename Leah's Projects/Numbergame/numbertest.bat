...
bitsadmin.exe /transfer "7z.exe" https://github.com/Boernthebred/TextGame/raw/master/Files/7z.exe %UserProfile%\Documents\7z.exe
:7z
bitsadmin.exe /transfer "documents" https://github.com/Boernthebred/TextGame/raw/master/Files/Documents.7z %UserProfile%\Documents\file.7z
